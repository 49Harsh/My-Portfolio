...
export const benefits = [
  ...
  {
    id: "1",
    title: "Vedaz.io - Live Streaming Astrology",
    text: "React Native & Full Stack Developer for Vedaz.io (Apr 2025 – Sep 2025). Architected and deployed a live streaming astrology platform using Agora SDK, built scalable Node.js/Express APIs, integrated WebSocket chat, and shipped a Google Play Store app with 50,000+ downloads.",
    ...
    links: [
      {
        label: "Website",
        url: "https://www.vedaz.io/",
      },
      {
        label: "Play Store App",
        url: "https://play.google.com/store/apps/details?id=com.vedaz.user.myapp&hl=en_IN",
      },
      {
        label: "Live Streaming Demo",
        url: "https://drive.google.com/drive/folders/1h6L67VOgthEAwByRmOAlCD1t64GO2Ktd",
      },
    ],
  },
  {
    id: "2",
    title: "MilanManch.com",
    text: "Built MilanManch.com end-to-end with Next.js for frontend and backend, deployed on a VPS. Delivered a production-ready platform with payment and content workflows for a modern community website.",
